...
db.serialize(() => {
    db.run("CREATE TABLE IF NOT EXISTS attendees (id INTEGER PRIMARY KEY, last_name TEXT, first_name TEXT, company TEXT, email TEXT, present BOOLEAN)");
});
...
app.post('/upload-csv', upload.single('file'), (req, res) => {
    ...
    fs.createReadStream(filePath)
        ...
        .on('data', (row) => {
            ...
            db.run("INSERT INTO attendees (last_name, first_name, company, email, present) VALUES (?, ?, ?, ?, ?)", [last_name, first_name, company, email]);
